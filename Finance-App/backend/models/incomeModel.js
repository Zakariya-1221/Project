...
// Creating a new Mongoose schema called IncomeSchema
const IncomeSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    default: "income"    // Sets a default value of "income" if the field is not provided
  },
...
// Creating and exporting a Mongoose model named "Income" using the IncomeSchema
